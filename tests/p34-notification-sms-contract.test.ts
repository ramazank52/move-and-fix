...
import { NotificationChannel, NotificationService, NotificationType } from "../server/services/NotificationService";

describe("P34 Twilio SMS recipient contract", () => {
  beforeEach(() => {
    fetchMock.mockReset();
  ...
  it("sends the validated Turkish recipient as E.164 rather than raw profile input", async () => {
